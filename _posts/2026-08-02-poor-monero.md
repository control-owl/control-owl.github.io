...
I started mining Monero for the first time when it was around 1 cent per coin. My god, it was a long time ago. This was my best coin after Bitcoin. I managed to mine 1000 Moneros back then and managed to sell them all when the coin price went to 10$/coin.

$10,000 earned from almost nothing. I was so happy back then. 
...
I really do not know, even now, how crypto miners are working, so I went on the internet and asked chappity. I was really surprised that it did not want to answer my question when I wanted to go into the low-level details. It gave me some superficial details about how mining in general works, but when I wanted to know every single detail, it stopped to answer. I asked grok. I wrote very detailed prompts, not skipping anything, and every time I pressed Enter, I got an error. God-damn, I asked Claude, Mistral, GPT-OSS, Gemma, ChatGPT and Grok. **None of them wanted to help me!**.

I invested days in asking the same question in another way and there was no help.
...
Since writing CPU miner will require another task, and that is writing support for Monero in (eQ)[eq], I switched to add wallet support and then to start CPU miner.
...
My problem is not if I can write code, I can. My problem is when I click generate wallet in (eQ)[eq], and when I see that the Monero address is generated, I have to verify that the generated keys are properly derived or I messed something up. This is 99% of all my problems. I need to find on the internet whole derivation keys in order to compare them with mine. But finding on the internet exactly what I need are sometimes days of searching. To shorten my research time, I sometimes ask AI.
...
[eQ]:        https://github.com/control-owl/eQ